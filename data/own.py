...
class Own(data.Dataset):
    ...
    train_folder = 'train/data_patch'
    train_lbl_folder = 'train/anno_patch'

    # Validation dataset root folders
    val_folder = 'val/data_patch'
    val_lbl_folder = 'val/anno_patch'

    # Test dataset root folders
    test_folder = 'test/data_patch'
    test_lbl_folder = 'test/anno_patch'
